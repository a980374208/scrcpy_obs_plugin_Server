...
public final class Server {
    ...
    private static void scrcpy(Options options) throws IOException, ConfigurationException {
        ...
        try {
            ...
            if (video) {
                ...
                SwitchingCapture switchingCapture = new SwitchingCapture(controller, options);
                SurfaceEncoder surfaceEncoder = new SurfaceEncoder(switchingCapture, videoStreamer, controller, options);
                asyncProcessors.add(surfaceEncoder);

                if (controller != null) {
                    controller.setSurfaceCapture(switchingCapture);
    ...
    private static void internalMain(String... args) throws Exception {
        ...
        if (options.getListDeviceInfos()) {
            Workarounds.apply();
            System.out.println(LogUtils.buildDeviceInfosJson());
            return;
        }
