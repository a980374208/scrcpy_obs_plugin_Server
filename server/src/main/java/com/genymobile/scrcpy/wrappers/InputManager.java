                ...
                if (cause instanceof SecurityException) {
                    ...
                    if (message != null && message.contains("INJECT_EVENTS permission")) {
                        ...
                        if (lastPermissionLogDate <= now - 3000) {
                            ...
                            com.genymobile.scrcpy.control.Controller controller = com.genymobile.scrcpy.control.Controller.getInstance();
                            if (controller != null) {
                                controller.sendMessage(com.genymobile.scrcpy.control.DeviceMessage.createError(
                                        2, "Make sure you have enabled \"USB debugging (Security Settings)\" and then rebooted your device."));
                            }
                        }
