...
public class Options {
    ...
    private boolean listDeviceInfos;
    ...
    public boolean getList() {
        return listEncoders || listDisplays || listCameras || listCameraSizes || listApps || listDeviceInfos;
    }
    ...
    public boolean getListDeviceInfos() {
        ...
        for (int i = 1; i < args.length; ++i) {
            ...
            switch (key) {
                ...
                case "list_apps":
                    ...
                    break;
                case "list_device_infos":
                    options.listDeviceInfos = Boolean.parseBoolean(value);
                    break;
                case "camera_id":
                    if (!value.isEmpty()) {
